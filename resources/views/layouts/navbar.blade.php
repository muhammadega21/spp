<!-- Navbar -->
<nav class="navbar w-full bg-base-100 border-b border-gray-200">
    <label for="my-drawer-4" aria-label="open sidebar" class="btn btn-square btn-ghost block lg:hidden">
